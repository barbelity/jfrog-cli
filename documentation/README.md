...
> If you modified the default JFrog CLI home directory by setting JFROG\_CLI\_HOME\_DIR environment variable, then the **security/security.yaml** file should br created under the configured home directory.
